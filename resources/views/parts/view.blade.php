                            ...
                            <tr class="hover">
                                ...
                                <td class="text-center">
                                    <button class="btn btn-sm btn-info text-white w-max" onclick="">
                                        ...
                                        <p class="xs:hidden lg:flex">View</p>
                                    </button>
                                </td>
                            </tr>
                        @endforeach
...
{{--                                <p>{{ $index + 1 }}. {{$item->specs}}: {{ $item->specs_value }}</p>--}}
{{--                              @endforeach--}}
{{--                            </td>--}}
{{--                            <td>--}}
...
{{--                                      </button>--}}
{{--                                  </a>--}}
{{--                                  <button class="btn btn-sm btn-error text-white" onclick="showDeleteDialog('{{ $vehicle->id }}')">--}}
{{--                                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">--}}
...
{{--                    @endif--}}
    ...
    <script>
      ...
      function submitDeleteForm() {
        ...
        form.action = form.action.replace('vehicleId', vehicleId);
