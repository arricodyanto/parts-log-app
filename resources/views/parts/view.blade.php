                            ...
                            <tr class="hover">
                                ...
                                <td class="text-center">
                                    <div class="flex xs:flex-col md:flex-row gap-2 justify-center">
                                        ...
                                        <button class="btn btn-sm btn-error text-white w-max" onclick="showDeleteDialog('{{ $vehicle->vehicle_id }}')">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
...
{{--                      <form action="{{ route('parts.delete', ['vehicle_id' => $vehicle->vehicle_id]) }}" method="post" id="delete-form">--}}
                      <form action="{{ route('parts.delete', ['vehicle' => $vehicle->id]) }}" method="post" id="delete-form">
                      @csrf
                      @method('delete')
    ...
    <script>
      ...
      function submitDeleteForm() {
        ...
        form.action = form.action.replace('vehicle_id', vehicleId);
