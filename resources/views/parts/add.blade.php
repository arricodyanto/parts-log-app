...
@section('content')
    <div class="container mt-8 mb-16">
        ...
        <section id="form" class="mx-auto">
            <form id="specifications-form" method="POST" action="{{ route('parts.store') }}" enctype="multipart/form-data">
                @csrf
                @method('POST')
                ...
                <div id="vehicle-uid">
                    ...
                    <select name="unit" class="select select-bordered xs:w-full md:w-1/2" required>
                                ...
                                <div class="flex xs:flex-col md:flex-row gap-2 w-full">
                                    <div class="flex flex-col gap-2 w-full">
                                        <div>
                                            ...
                                            <input type="number" name="hours_meter" placeholder="Input part hours meter" class="input input-bordered w-full" />
                                        </div>
                                        <div>
                                            <div class="label">
                                                <span class="label-text">Description</span>
                                            </div>
                                            <textarea class="textarea textarea-bordered w-full" name="desc" placeholder="Descriptions"></textarea>
                                        </div>
                                        <div>
                                            <div class="label">
                                                <span class="label-text">Part Description</span>
                                            </div>
                                            <textarea class="textarea textarea-bordered w-full" name="part_desc" placeholder="Part Descriptions"></textarea>
                                        </div>
                                    </div>
                                    <div class="flex flex-col gap-2 w-full">
                                        <div class="xs:block md:flex md:gap-2 w-full">
                                            <div class="w-full">
                                                ...
                                                <input type="number" name="qty" placeholder="Input part quantity" class="input input-bordered w-full" />
                                            </div>
                                            <div class="w-full">
                                                <div class="label">
                                        ...
                                        <div class="xs:block md:flex md:gap-2 w-full">
                                            <div class="w-full">
                                                ...
                                                <label class="input input-bordered flex items-center gap-2">
                                                    <input type="number" name="repl" placeholder="Input part repl" class="grow border-none active:ring-0 focus:ring-0" />
                                                    %
                                                </label>
                                            </div>
                                            <div class="w-full">
                                                ...
                                                <label class="input input-bordered flex items-center gap-2">
                                                    ...
                                                    <input type="number" name="price" placeholder="Input part price" class="grow border-none active:ring-0 focus:ring-0" />
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="flex gap-2 w-full mt-8">
                    ...
                    <button type="submit" class="btn btn-primary text-white xs:w-fit md:w-1/5">Save Changes</button>
