                        ...
                        <div class="flex justify-center mb-2 specification-row">
                            <div class="flex gap-2 items-end w-full">
                                ...
                                <div class="xs:w-full md:w-3/4">
                                    ...
                                    <input type="text" name="specifications[{{ $index }}][specs]" value="{{ $item->specs }}" class="input input-bordered w-full" />
                                </div>
                                <div class="div w-full">
                                    <div class="label">
                                        <span class="label-text">Specifications Value</span>
                                    </div>
                                    <input type="text" name="specifications[{{ $index }}][specs_value]" value="{{ $item->specs_value }}" class="input input-bordered w-full" />
                                </div>
            ...
            newRow.innerHTML = `
                <div class="flex gap-2 items-end w-full">
                    ...
                    <div class="w-3/4">
                        ...
                        <input type="text" name="specifications[${index}][specs]" value="${specData.specs || ''}" class="input input-bordered w-full" />
                    </div>
                    <div class="div w-full">
                        <div class="label">
                            <span class="label-text">Specifications Value</span>
                        </div>
                        <input type="text" name="specifications[${index}][specs_value]" value="${specData.specs_value || ''}" class="input input-bordered w-full" />
                    </div>
                    <button class="btn btn-circle btn-sm mb-2" onclick="removeRow(this)">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" /></svg>
                    </button>
